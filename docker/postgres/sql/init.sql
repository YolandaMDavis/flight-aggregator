...
--
-- Name: flight_records; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.flight_records (
    ...
    "trueTrack" double precision,
    "verticalRate" double precision,
    sensors character varying,
    geo_altitue double precision,
    squawk character varying,
    spi boolean NOT NULL,
    "positionSource" integer NOT NULL,
    "unknownField" integer NOT NULL
);


ALTER TABLE public.flight_records OWNER TO postgres;
